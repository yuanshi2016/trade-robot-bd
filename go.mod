...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1243
	...
	github.com/go-kratos/kratos/middleware/recovery/v2 v2.0.0-20210831021457-f7588a47de80
	...
	github.com/zhufuyi/pkg v0.0.0-20210721024957-dc3d644a7ed2
