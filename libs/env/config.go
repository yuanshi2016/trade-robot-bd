...
var (
	...
	ExchangeAccessURL = "https://yun.yuanshi01.com/exchange/v1/exchange/apiInfo"
	// StatisticalInfoURL 获取统计信息URL url后面需要加参数 /:user_id/:strategyId
	StatisticalInfoURL = "https://yun.yuanshi01.com/exchange/v1/user/strategy/evaluationNoAuth"
	// NotifyStatisticsURL 通知统计URL
	NotifyStatisticsURL = "https://yun.yuanshi01.com/exchange/v1/forward-offer/orderGrid"
	// NotifyStrategyStartUpURL 启动策略通知接口
	NotifyStrategyStartUpURL = "https://yun.yuanshi01.com/wallet/v1/wallet/strategyStartUpNotify"
	//ProxyAddr                = ""
