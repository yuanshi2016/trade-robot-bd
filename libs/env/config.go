...
var (
	...
	ExchangeAccessURL = "https://yun.local_100.com/test/exchange/v1/exchange/apiInfo"
	// StatisticalInfoURL 获取统计信息URL url后面需要加参数 /:user_id/:strategyId
	StatisticalInfoURL = "https://yun.local_100.com/test/exchange/v1/user/strategy/evaluationNoAuth"
	// NotifyStatisticsURL 通知统计URL
	NotifyStatisticsURL = "https://yun.local_100.com/test/exchange/v1/forward-offer/orderGrid"
	// NotifyStrategyStartUpURL 启动策略通知接口
	NotifyStrategyStartUpURL = "https://yun.local_100.com/test/wallet/v1/wallet/strategyStartUpNotify"
	//ProxyAddr                = ""
