...
func (e *ExOrderRepo) EvaluationSpot(req *pb.OrderReq) error {
	...
	trade := &model.WqTradeRecord{
		...
		Unit:          req.Unit,
		Commission:    helper.Float64ToString(commission),
		Volume:        req.Volume,
		CreatedAt:     time.Now(),
		UpdatedAt:     time.Now(),
	}
...
func (e *ExOrderRepo) CreateWqProfitDaily(profit *model.WqProfit) error {
...
func (e *ExOrderRepo) StrategyProfitCompensate(strategyId string, price float64) error {
